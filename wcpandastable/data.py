...
class TableModel(object):
    ...
    def __init__(self, dataframe=None, rows=20, columns=5):
        ...
        print('\npandastable data reviewed')

        self.available_to_model = {}  # [NG] added
        self.class_label_status = {}  # [NG] added
        self.nominal_ordinal = {}  # [NG] added
        return
    ...
    def addColumn(self, colname=None, dtype=None, data=None):
        ...
        # NEED TO ADD TRANSFORMATION

        # [NG] added 3 lines below
        ...
        print(max(list(self.available_to_model)))
    ...
    def setValueAt(self, value, rowindex, colindex):
        ...
        #print('\nType value before: {}'.format(type(value)))
        ...
        # [NG] if the inserted value is different
