...
from toolbox import exec_qry, is_even
...
class ClassifiersModelOverrides(tk.Toplevel):
    ...
    def __init__(self, parent, callback=None):
        ...
        self.title('Classifiers Overrides')
        self.parent = parent
    ...
    def create_right_buttons(self):
        ...
        ttk.Button(self.right_buttons_frame, text='Reset Defaults',
                   command=self.on_reset_defaults_button_clicked).grid(
                   row=5, column=2, sticky="nsew", padx=10, pady=1)
    ...
    def on_toggle_scaling_button_clicked(self):
        ...
        if self.is_scaling_selected() is True:
            qry = 'UPDATE ModelOverrideAlgorithms SET NeedsScaling=? WHERE AlgorithmID=?'
    ...
    def on_toggle_selected_button_clicked(self):
        ...
        if self.is_classifier_selected() is True:
            qry = 'UPDATE ModelOverrideAlgorithms SET IsSelected=? WHERE AlgorithmID=?'
    ...
    def on_reset_defaults_button_clicked(self):

        if messagebox.askyesno("Warning", "Do you want to reset settings " +
                               "to default values?"):
    ...
    def on_reset_param_defaults_button_clicked(self):
    ...
    def view_classifiers(self):
        ...
        qry = 'SELECT * FROM ModelOverrideAlgorithms WHERE AlgorithmTypeID=1 ORDER BY AlgorithmDesc'
    ...
    def view_params(self):
        ...
        qry = 'SELECT * FROM ModelOverrideAlgorithmParams WHERE AlgorithmID=? ORDER BY ParamName DESC'
    ...
    def show_classifier_entries(self, frame):
        ...
        self.algorithm_docs_label.grid(row=4, column=0, sticky="nsew",
                                       padx=1, pady=1)
        ...
        self.algorithm_docs_entry.grid(row=4, column=1, sticky="nsew",
                                       padx=1, pady=1)
        ...
        self.algorithm_guides_label.grid(row=5, column=0, sticky="nsew",
                                         padx=1, pady=1)
        ...
        self.algorithm_guides_entry.grid(row=5, column=1, sticky="nsew",
                                         padx=1, pady=1)
        ...
        self.algorithm_wiki_label.grid(row=6, column=0, sticky="nsew",
                                       padx=1, pady=1)
        ...
        self.algorithm_wiki_entry.grid(row=6, column=1, sticky="nsew",
                                       padx=1, pady=1)
    ...
    def show_param_entries(self, frame):
        ...
        self.defaults_to_entry.grid(row=2, column=1, sticky="nsew",
                                    padx=1, pady=1)
        # self.add_tooltip_to_widget(self.defaults_to_entry)
        # self.defaults_to_entry.configure(state='readonly')
        ...
        # self.add_tooltip_to_widget(self.is_optional_combo)
        # self.is_optional_combo.bind('<<ComboboxSelected>>',
        #                            self.on_is_optional_combo_change)
        ...
        # self.add_tooltip_to_widget(self.is_selected_combo)
        # self.is_selected_combo.bind('<<ComboboxSelected>>',
        #                            self.on_is_selected_combo_change)
    ...
    def populate_entries(self, frame):
        ...
        for row in cursor:
            ...
            if row[4] is not None:
                self.update_disabled_widget(self.algorithm_docs_entry, row[4])
            if row[5] is not None:
                self.update_disabled_widget(self.algorithm_guides_entry, row[5])
            if row[6] is not None:
                self.update_disabled_widget(self.algorithm_wiki_entry, row[6])

    def populate_param_entries(self, frame):

        qry = 'SELECT * FROM ModelOverrideAlgorithmParams WHERE AlgorithmParamID=?'
    ...
    def open_edit_params_window(self):
        ...
        self.edit_params_window.title('Edit Parameter Overrides')
        ...
        ttk.Button(self.right_buttons_frame, text="Reset Defaults",
                   command=self.on_reset_param_defaults_button_clicked).grid(
    ...
    def open_modify_param_window(self):
        ...
        self.modify_param_window.title('Edit Parameter Overrides')
    ...
    def update_param(self, frame):
        ...
        qry = "UPDATE ModelOverrideAlgorithmParams SET " \
            "DefaultsTo=?, " \
            "IsSelected=? " \
    ...
    def get_algorithm_id(self, algorithm_desc_str):
        ...
        qry = "SELECT AlgorithmID FROM ModelOverrideAlgorithms WHERE {cond}=?".\
    ...
    def get_algorithm_param_id(self, param_name, algorithm_id):
        ...
        qry = "SELECT AlgorithmParamID FROM ModelOverrideAlgorithmParams WHERE ParamName=? AND AlgorithmID=?"
...
class TrainAndTestSplitOverrides(tk.Toplevel):
    ...
    def __init__(self, parent, callback=None):
        ...
        self.title('Train and Test Split Overrides')
        self.parent = parent
    ...
    def create_options_area(self):
        ...
        self.train_size_entry.grid(row=1, column=1, sticky="nsew",
                                   padx=1, pady=1)
        # self.add_tooltip_to_widget(self.train_size_entry)
        # self.train_size_entry.configure(state='readonly')
        ...
        self.test_size_entry.grid(row=2, column=1, sticky="nsew",
                                  padx=1, pady=1)
        # self.add_tooltip_to_widget(self.test_size_entry)
        # self.test_size_entry.configure(state='readonly')
    ...
    def create_buttons_area(self):
        ...
        self.reset_defaults_button = \
            ttk.Button(self.buttons_frame,
                       text="Reset Defaults",
                       name="reset_defaults_button",
                       command=self.on_reset_defaults_button_clicked)
        self.reset_defaults_button.grid(row=1, column=1, sticky="nsew",
                                        padx=5, pady=1)
    ...
    def populate_entries(self):
        ...
        for row in cursor:
            ...
            self.train_size_entry.delete(0, tk.END)
    ...
    def save_override(self):
        ...
        qry = "UPDATE ModelOverrides SET " \
            "ModelOverrideInt1=?, ModelOverrideInt2=?, ModelOverrideFloat1=?, " \
            "ModelOverrideFloat2=? " \
            "WHERE ModelOverrideName=?"
...
class ScalingOverrides(tk.Toplevel):
